...
parser.add_argument('--input_dir', default='F:/wj/SRMNet-main/data/test', type=str,
                      help='Directory of validation images')
...
parser.add_argument('--weights', default='./checkpoints/SRMNet_denoise/models/model_latest.pth', type=str,
                    help='Path to weights')
